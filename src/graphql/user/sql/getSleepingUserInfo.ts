...
const getSleepingUserInfoIR: any = {
  usedParamSet: {},
  params: [],
  statement:
 ...
 * ```
 */
export const getSleepingUserInfo = new PreparedQuery<
  IGetSleepingUserInfoParams,
  IGetSleepingUserInfoResult
>(getSleepingUserInfoIR)
